...
void Craft::position(float width, float height)
{
	...
	select[0].setPosition(Vector2f(800, height / (MAX_NUMBER_OF_CRAFT + 1) * 0));// set the position
	...
	select[1].setPosition(Vector2f(800, height / (MAX_NUMBER_OF_CRAFT + 1) * 1));// set the position
	...
	select[2].setPosition(Vector2f(800, height / (MAX_NUMBER_OF_CRAFT + 1) * 2));// set the position
	...
	select[3].setPosition(sf::Vector2f(800, height / (MAX_NUMBER_OF_CRAFT + 1) * 3));// set the position
	...
	select[4].setPosition(sf::Vector2f(800, height / (MAX_NUMBER_OF_CRAFT + 1) * 4));// set the position
